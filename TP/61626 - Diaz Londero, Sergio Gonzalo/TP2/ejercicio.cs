...
class ProgramaPrueba
{
    public ProgramaPrueba()
    {
        Console.WriteLine("¡Hola, C#! El programa funciona correctamente.");
    }
}

// Crear una instancia de la clase para que se ejecute automáticamente
class Ejecutar
{
    static Ejecutar()
    {
